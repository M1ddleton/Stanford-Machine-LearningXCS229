...
that might otherwise seem unrelated. As we dive into the problem, 
\href{https://ermongroup.github.io/cs228-notes/inference/variational/}{this resource} will help you determine more properties about KL Divergence. 
...
If the cross entropy between $P$ and $Q$ is $H(P)$ (and hence $\KL(P\mid \mid Q) = 0$) then it necessarily
...
\begin{enumerate}
  ...
  \input{01-kl_divergence/01-nonnegative}

  \input{01-kl_divergence/02-chain_rule}

  \input{01-kl_divergence/03-max_likelihood}
